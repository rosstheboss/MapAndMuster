...
10. Resolved: territory control awards campaign points in the Territories and structures column
    when a running objective for points per territory is configured above 0. Most territories
    currently controlled remains a ranking public objective scored in Public Objectives. See
    `docs/DOMAIN.md`.
