...
Public privacy policy URL for provider consoles: `https://mapandmuster.com/privacy`.
Public terms of service URL: `https://mapandmuster.com/terms` (Discord verification
qualifications; optional for Google). Publish the Google consent screen to **In production**
so users do not see Google's unsafe-app warning. Details: `docs/authentication-production.md`.
