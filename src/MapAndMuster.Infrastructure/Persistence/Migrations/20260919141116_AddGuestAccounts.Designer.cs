...
namespace MapAndMuster.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260919141116_AddGuestAccounts")]
    partial class AddGuestAccounts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MapAndMuster.Infrastructure.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<int?>("GuestAccountNumber")
                        .HasColumnType("integer");

                    b.Property<DateTimeOffset?>("GuestExpiresUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("GuestAccountNumber")
                        .IsUnique()
                        .HasFilter("\"GuestAccountNumber\" IS NOT NULL");

                    b.HasIndex("GuestExpiresUtc")
                        .HasFilter("\"IsGuestAccount\" = TRUE");
            ...
            modelBuilder.Entity("MapAndMuster.Infrastructure.Persistence.Entities.CampaignRecord", b =>
                {
                    ...
                    b.HasIndex("IsPubliclyViewable", "StartsUtc");
