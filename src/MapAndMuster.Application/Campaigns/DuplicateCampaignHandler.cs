...
public sealed class DuplicateCampaignHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var copy = new StoredCampaign
        {
            ...
            TerrainTags = [.. source.TerrainTags],
            StructureTags = [.. source.StructureTags],
            FactionTags = [.. source.FactionTags],
            MissionTags = [.. source.MissionTags],
    ...
    private static bool TryShiftSchedule(
        ...
        out MapAndMuster.Domain.Common.DomainError? error)
    {
        startsUtc = default;
        endsUtc = default;
        error = null;
        ...
        if (timeZone is null)
        {
            error = new MapAndMuster.Domain.Common.DomainError(
                "timeZone.invalid",
