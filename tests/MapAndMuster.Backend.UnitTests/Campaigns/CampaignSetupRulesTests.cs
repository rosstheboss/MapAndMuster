...
public sealed class CampaignSetupRulesTests
{
    ...
    private static bool TryMinimal(string name, out IReadOnlyList<MapAndMuster.Domain.Common.DomainError> errors)
    {
    ...
    private static bool TryMinimal(
        string name,
        out IReadOnlyList<MapAndMuster.Domain.Common.DomainError> errors,
