...
public sealed class CampaignChatRulesTests
{
    ...
    {
        var succeeded = Campaign.Domain.Campaigns.CampaignSetupRules.TryCreate(
            "Border War",
            null,
            8,
            false,
            ...
            true,
            0,
            [new Campaign.Domain.Campaigns.FactionInput { Name = "North" }, new Campaign.Domain.Campaigns.FactionInput { Name = "South" }],
            null,
            null,
            new Campaign.Domain.Campaigns.CampaignScheduleInput
            {
                TimeZoneId = "UTC",
                ...
                Phases =
                [
                    new Campaign.Domain.Campaigns.RoundPhaseInput { Kind = "Action", DurationAmount = 6, DurationUnit = "Minutes" },
                    new Campaign.Domain.Campaigns.RoundPhaseInput { Kind = "Battle", DurationAmount = 4, DurationUnit = "Minutes" },
                ],
            },
            out var setup,
            out _,
        ...
        return new Campaign.Domain.Campaigns.CampaignSchedule(
